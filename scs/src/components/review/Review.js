...
const Review = () => {
  ...
  useEffect(() =>{
      ...
      axios({
        method: 'post',
        url: 'http://localhost/Team30API/review.php',
      ...
      axios({
        method: 'post',
        url: 'http://localhost/Team30API/get_review_user.php',
        headers: { 'content-type': 'application/json' },
      ...
      axios({
        method: 'post',
        url: 'http://localhost/Team30API/get_products.php',
        headers: { 'content-type': 'application/json' },
        data: localStorage.getItem('username')
      })
      .then(res =>{
  ...
  useEffect(() => {
    axios({
      method: 'post',
      url: 'http://localhost/Team30API/submit_review.php',
      headers: { 'content-type': 'application/json' },
      data: submitReview
    })
   .catch(err =>{ 
  ...
  useEffect(() => {
    if(chosenReview !== ""){
      axios({
        method: 'post',
        url: 'http://localhost/Team30API/get_product_review.php',
        headers: { 'content-type': 'application/json' },
        data: chosenReview
      })
      .then(res =>{
