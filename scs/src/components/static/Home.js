    ...
    <div>
      ...
      <div id="home">
          <div id ="home-info">
              ...
              <Link to={'/products'}><button className="waves-effect waves-light btn" href="/products" style={{background: "#149BBB"}}><i className="material-icons left">shopping_basket</i>Products</button></Link>
          </div>
      ...
      <div id = "about-sec">
          <div id = "about-area">
              ...
              <Link to={'/about'}><button className="waves-effect waves-light btn" href="/about" style={{background: "#149BBB"}}><i className="material-icons left">assignment</i>About Us</button></Link>
          </div>  
      </div>
      <div id="contact-sec">
          <div id= "contact-area">
              ...
              <Link to={'/contact'}><button className="waves-effect waves-light btn" href="/contact" style={{background: "#149BBB"}}><i className="material-icons left">question_answer</i>Contact Us</button></Link>
          </div>
