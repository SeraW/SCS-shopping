...
<head>
  ...
  <link rel="stylesheet" href="css/whitefooter.css" type="text/css">
...
<footer class="page-footer">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                <h5 ><span class="highlight">Smart</span> Customer <span class="highlight">Services</span></h5>
          ...
          <div class="footer-copyright">
           ...
           Copyright © 2022 <span class="highlight">Smart</span> Customer <span class="highlight">Services</span>
            <a href="contact.php" class="right" href="#!" style="color: #393D3F"><span class="highlight">Questions? </span><u>Contact us!</u></a>
            </div>
          </div>
        </footer>
